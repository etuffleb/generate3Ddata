...
bpy.ops.mesh.primitive_cylinder_add(vertices=64, radius=1, depth=3, location=(0, 0, 1.5), end_fill_type='NGON')
...
tex_image.image = bpy.data.images.load(filepath='/Users/ekaterina/Desktop/coca.png')  # замените путь
